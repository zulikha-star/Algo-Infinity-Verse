...
const visualizers = [
  ...
  { name: "Operational Transformation (OT) Simulator", path: "/pages/visualizers/ot-simulator/ot-simulator.html", category: "Distributed Systems", icon: "fa-random", desc: "Interactive OT network simulator showing transformation math and conflict resolution." },
