...
window.roadmapSteps = [
  {
    ...
    description: 'Master array basics, indexing, and common patterns',
    category: 'core',
    difficulty: 'Easy',
  ...
  },
  {
    ...
    description: 'DFS, BFS, and recursive tree algorithms',
    category: 'core',
    difficulty: 'Medium',
    estimatedTime: '3-4 hours',
    completed: false,
  },
  {
    ...
    description: 'BFS, DFS, and graph representations',
    category: 'core',
    difficulty: 'Hard',
